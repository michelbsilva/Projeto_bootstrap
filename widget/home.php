        ...
        <div class="row">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16y9">
                        <a href="">
                            <img src="properties/3/f6020214-9d26-4904-b24b-2f447ef7c4f8.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Campeche com vista para o Mar</a></h2>
        ...
        <div class="row">
            ...
            <article class="col-12 col-md-6 col-lg-4 mb-4">
                <div class="card main_properties_item">
                    <div class="img-responsive-16y9">
                        <a href="">
                            <img src="properties/1/e26a89b3-6dcb-4c74-bc1f-59090b2a1f86.jpg" class="card-img-top" alt="">
                        </a>
                    </div>
                    <div class="card-body">
                        <h2><a href="#" class="text-front">Linda Casa no Campeche com vista para o Mar</a></h2>
