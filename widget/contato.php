<div class="main_contact py-5 bg-light text-center">
    <div class="container">
            ...
            <p class="mb-0">Quer conversar com um corretor exclusivo e ter o atendimento diferenciado em busca do seu imível dos sonhos?</p>
            <p>Preencha o formulário  abaixo e vamos lhe direcionar para alguém que entende a sua necessidade!</p>

        <div class="row text-left">
            <form action="">
                <h2 class="icon-envelope text-black-50">Envie um email</h2>
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Insira seu nome">
                </div>
                
                <div class="form-group">
                    <input type="email" class="form-control" placeholder="Insira seu melhor email">
                </div>
                ...
                <div class="form-group">
                    <textarea rows="5" class="form-control" placeholder="Digite sua mensagem"></textarea>
                </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-12 col-md-4">
                ...
                <p class="pt-2"><a href="#" class="text-front">michel.barros94@gmail.com</a></p>
            </div>
            
            <div class="col-12 col-md-4">
                <h2 class="icon-phone">Por Telefone</h2>
                <p>Estamos disponíveis nos números abaixo no horário comercial!</p>
                <p class="text-front pt-2">(85) 3479-1922</p>
            </div>
